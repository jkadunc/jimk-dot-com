...
function DiplomaIcon(props: unknown): ReactElement {
	return (
		<SvgIcon {...props}>
...
function FlaskIcon(props: unknown): ReactElement {
	return (
		<SvgIcon {...props}>
...
function CalculatorIcon(props: unknown): ReactElement  {
	return (
		<SvgIcon {...props}>
...
function Icon(props: any): ReactElement {
	if (!props.type) {
		return <> </>;
	}
